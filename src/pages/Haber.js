...
function Haber() {
  ...
  <br/><br/> <br/> <br/>
        <h1 className='mt-5'>C/C++ KURSU BAŞVURULARI</h1>
        
        <div className='container py-5'>
        <img src="https://i.hizliresim.com/mn82e7j.jpg" className="d-inline w-50 float-start mx-4 my-2 shadow-lg rounded"></img>
