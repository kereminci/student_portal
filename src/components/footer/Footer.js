					...
					<div class="row">
						...
						<h4 style={{ color: "#11253e" }}>.</h4>
							<ul>
								...
								<li><Link to="/ogrenci">Ogrenci</Link></li>
								<li><Link to="/bilgiislem">Bilgi İşlem</Link></li>
							</ul>
						</div>
						<div class="footer-col">
							<h4 style={{ color: "#11253e" }}>.</h4>
